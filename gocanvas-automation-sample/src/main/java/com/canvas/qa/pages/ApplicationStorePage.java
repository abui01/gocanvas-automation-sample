...
public class ApplicationStorePage extends BasePage

{
	 ...
	 */
	public ApplicationStorePage(WebDriver driver) {
		this.driver = driver;
	...
	public ApplicationStorePage allAppsButtonClick() throws InterruptedException {
		// Thread.sleep(2000);
	...
	public ApplicationStorePage clickAppSearchButton() {
		clickOnHiddenElement(appSearchButton, driver);
		return this;
	}

	public ApplicationStorePage clickCountryCheckbox(String country) {
		WebElement element = driver.findElement(By.xpath(String.format(countryCheckBoxXpath, country)));
		clickOnHiddenElement(element, driver);
		return this;
	}

	public ApplicationStorePage clickCountryFilter() {
		clickOnHiddenElement(countryFilter, driver);
		return this;
	}

	public ApplicationStorePage clickDDLOption(String option) {
	...
	public ApplicationStorePage clickGetAppWithDepartment(String appName) {
		WebElement element = driver.findElement(By.xpath(String.format(appNameXpath, appName)));
		clickOnHiddenElement(fluentWait(element, driver), driver);
		getAppButton.click();
		return this;
	...
	public ApplicationStorePage clickTryItFreeButton() {
		clickOnHiddenElement(fluentWait(tryItFreeButton, driver), driver);
		return this;
	}

	public ApplicationStorePage clickViewAllApps() throws InterruptedException {
		fluentWait(allAppsButton, driver).click();
		return this;
	}

	public ApplicationStorePage enterAppToSearch(String appName) {
		fluentWait(appSearchTextBox, driver).sendKeys(appName);
		return this;
	}

	public ApplicationStorePage enterFieldData(String fieldID, String data) {
	...
	public ApplicationStorePage getApp(String appName) throws NoSuchElementException {
	...
	public ApplicationStorePage selectDepartment(String department) {
		Select dropdown = new Select(departmentDDL);
		dropdown.selectByVisibleText(department);
		return this;
	}

	public ApplicationStorePage selectEmployeeSize(int index) {
		Select dropdown = new Select(employeeSize);
		dropdown.selectByIndex(index);
		return this;
	}

	public ApplicationStorePage selectSortOption(String option) {
		Select dropdown = new Select(sortByDDL);
		dropdown.selectByVisibleText(option);
		return this;
	}

	public ApplicationStorePage step2Phone(String phone) throws IOException {
